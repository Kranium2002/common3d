#!/bin/bash
#SBATCH -J 07-06_17-17-50_CO3D_NeMo_Rec_slurm
#SBATCH --nodes 1
...
od3d bench single-local -c /work/dlclarge2/mathurv-mathurv-cv1project/common3d/home/tmp/config_07-06_17-17-50_CO3D_NeMo_Rec_slurm.yaml &
